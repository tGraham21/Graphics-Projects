...
void setup(){
 size(600,600);
 surface.setTitle("A3 Scenario 3"); 
 background(125);
...
void initObstacles(){
 Obstacle obs1 = new Obstacle(-100, 100,0, 100 );
 obstacles.add(obs1);
 Obstacle obs2 = new Obstacle(0, 0,1, 70 );
 obstacles.add(obs2);
 Obstacle obs3 = new Obstacle(-100, -100,2, 100 );
 obstacles.add(obs3);
 Obstacle obs4 = new Obstacle(100, 100,3,100 );
 obstacles.add(obs4);
 Obstacle obs5 = new Obstacle(100, -100,4, 100 );
 obstacles.add(obs5);
}
